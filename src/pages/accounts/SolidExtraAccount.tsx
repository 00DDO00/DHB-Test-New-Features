    ...
    const fetchData = async () => {
      try {
        ...
        try {
          ...
          if (ibanData.success) {
            console.log('IBAN API success, setting options:', ibanData.data);
            ...
            console.log('IBAN API failed, using fallback options:', fallbackIbanOptions);
          ...
          console.log('IBAN API error, using fallback options:', fallbackIbanOptions);
          setIbanOptions(fallbackIbanOptions);
        }
      } catch (error) {
    ...
    try {
      ...
      if (data.success) {
        ...
        setTimeout(() => {
          ...
          console.log('Auto-filling demo code:', codeArray);
          setVerificationCode(codeArray);
        }, 1000);
      }
    } catch (error) {
      ...
      <Card sx={{ 
        ...
        <CardContent sx={{ p: 3 }}>
          <Typography variant="h5" fontWeight="bold" color="#333" sx={{ mb: 2 }}>
            Save and profit from interest rate increases
          </Typography>
          <Typography variant="body1" color="#666" sx={{ mb: 2, lineHeight: 1.6 }}>
            With the DHB SolidExtra Deposit Account, you benefit from Euribor interest rate increases while having a guaranteed basic interest rate. This means you always receive at least the guaranteed interest rate, but you can also benefit from higher interest rates when Euribor rises.
          </Typography>
          <Typography variant="body1" color="#666" sx={{ lineHeight: 1.6 }}>
            If you already have a DHB SaveOnline account, you can immediately open a DHB SolidExtra Deposit Account online for free.
          </Typography>
        </CardContent>
      </Card>
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Typography variant="body2" color="#666" sx={{ lineHeight: 1.5 }}>
                        ...
                        {' '}of DHB Bank SolidExtra Deposit Account and acknowledge the receipt of the{' '}
                        <MuiLink href="#" sx={{ color: '#004996', textDecoration: 'underline' }}>
