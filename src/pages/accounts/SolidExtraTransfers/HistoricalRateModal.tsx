...
const HistoricalRateModal: React.FC<HistoricalRateModalProps> = ({ open, onClose }) => {
  ...
  const rateHistory = [
    { month: 'January 2024', rate: '2.1%' },
    { month: 'February 2024', rate: '2.1%' },
    { month: 'March 2024', rate: '2.0%' },
    { month: 'April 2024', rate: '2.0%' },
    { month: 'May 2024', rate: '1.9%' },
    { month: 'June 2024', rate: '1.9%' },
    { month: 'July 2024', rate: '1.8%' },
    { month: 'August 2024', rate: '1.8%' },
    { month: 'September 2024', rate: '1.7%' },
    { month: 'October 2024', rate: '1.7%' },
    { month: 'November 2024', rate: '1.7%' },
    { month: 'December 2024', rate: '1.7%' }
  ];
