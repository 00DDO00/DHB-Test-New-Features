          ...
          <Grid container spacing={3} alignItems="center">
            ...
            <Grid item xs={12} md={6} sx={{ textAlign: 'right' }}>
              <Typography variant="h3" fontWeight="bold" color="#333" sx={{ mb: 1 }}>
                {accountData?.main_account?.balance || '€ --.---,--'}
              </Typography>
              <Typography variant="body1" color="#666" sx={{ mb: 0.5 }}>
                {accountData?.main_account?.iban || 'NL24DHBN2018470578'}
              </Typography>
              <Typography variant="body1" color="#666">
                {accountData?.main_account?.interest_rate || '1.1%'}
              </Typography>
            </Grid>
          </Grid>
        </CardContent>
      ...
      <Card sx={{ 
        ...
        <CardContent sx={{ p: 3 }}>
          <Typography variant="h5" fontWeight="bold" color="#333" sx={{ mb: 2 }}>
            {accountData?.description?.title || 'Many choices of different terms'}
          </Typography>
          <Typography variant="body1" color="#666" sx={{ mb: 2, lineHeight: 1.6 }}>
            {accountData?.description?.content || 'Do you want to benefit from a higher interest rate by fixing your savings for a certain period? With a DHB MaxiSpaar account, you can easily choose from different terms, from three months up to 5 years.'}
          </Typography>
          <Typography variant="body1" color="#666" sx={{ lineHeight: 1.6 }}>
            {accountData?.description?.additional || 'If you already have a DHB SaveOnline account, you can immediately open a DHB MaxiSpaar account online. That is free.'}
          </Typography>
        </CardContent>
      </Card>
